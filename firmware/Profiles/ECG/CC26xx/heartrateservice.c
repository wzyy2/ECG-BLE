...
#define HEARTRATE_FALL_VALUE_POS            5
...
// Command Characteristic
static uint8 heartRateFallProps = GATT_PROP_READ | GATT_PROP_WRITE;
static uint8 heartRateFall = 0;
                                      ...
                                      uint16_t maxLen, uint8_t method)
{
  ...
  if (uuid == HEARTRATE_CTRL_PT_UUID)
  {
    *pLen = 1;
